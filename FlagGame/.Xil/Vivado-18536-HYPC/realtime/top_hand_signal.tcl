...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/harman/HarmanSA_June_TeamPJ/FlagGame/.Xil/Vivado-18536-HYPC/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include C:/harman/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/TEXT_Display {
      ...
      rt::read_verilog -include C:/harman/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/TEXT_Display C:/harman/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/segCTRL/fndController.v
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top top_hand_signal
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/harman/HarmanSA_June_TeamPJ/FlagGame/.Xil/Vivado-18536-HYPC/"
