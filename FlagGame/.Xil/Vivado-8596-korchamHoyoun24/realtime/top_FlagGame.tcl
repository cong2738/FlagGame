...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/harman/_HARMAN Team Project/HarmanSA_June_TeamPJ/FlagGame/.Xil/Vivado-8596-korchamHoyoun24/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      rt::read_verilog -include {{C:/harman/_HARMAN Team Project/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/TEXT_Display}} {{C:/harman/_HARMAN Team Project/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/segCTRL/fndController.v}}
      rt::filesetChecksum
    }
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/harman/_HARMAN Team Project/HarmanSA_June_TeamPJ/FlagGame/.Xil/Vivado-8596-korchamHoyoun24/"
