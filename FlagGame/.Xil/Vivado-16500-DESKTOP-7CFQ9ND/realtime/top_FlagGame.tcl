...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/immune_working/HarmanSA_June_TeamPJ/FlagGame/.Xil/Vivado-16500-DESKTOP-7CFQ9ND/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include C:/immune_working/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/Graphic {
      ...
      rt::read_verilog -include C:/immune_working/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/Graphic C:/immune_working/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/segCTRL/fndController.v
      rt::filesetChecksum
    }
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/immune_working/HarmanSA_June_TeamPJ/FlagGame/.Xil/Vivado-16500-DESKTOP-7CFQ9ND/"
