...
HD_PWD='C:/harman/HarmanSA_June_TeamPJ/FlagGame/FlagGame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hand_signal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_hand_signal.tcl -notrace
