...
HD_PWD='C:/harman/HarmanSA_June_TeamPJ/FlagGame/FlagGame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hand_signal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_hand_signal.tcl
