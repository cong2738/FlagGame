...
namespace eval ::optrace {
  variable script "C:/harman/_HARMAN Team Project/HarmanSA_June_TeamPJ/FlagGame/FlagGame.runs/synth_1/FlagGame.tcl"
...
read_verilog -library xil_defaultlib -sv {{C:/harman/_HARMAN Team Project/HarmanSA_June_TeamPJ/FlagGame/FlagGame.srcs/sources_1/new/FlagGame.sv}}
...
synth_design -top FlagGame -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef FlagGame.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file FlagGame_utilization_synth.rpt -pb FlagGame_utilization_synth.pb"
